                    ...
                    <table class='table table-bordered' style="width:130%">
                        ...
                        <tr class='success'>
                            @foreach($table_columns as $k=>$column)
                                <?php
                                $help = '';
                                if ($column == 'id' || $column == 'created_at' || $column == 'updated_at' || $column == 'deleted_at' || $column == 'updated_by' || $column == 'created_by') continue;
                        ...
                        <tr>
                            @foreach($table_columns as $k=>$column)
                                <?php if ($column == 'id' || $column == 'created_at' || $column == 'updated_at' || $column == 'deleted_at' || $column == 'updated_by' || $column == 'created_by') continue;?>
                                <td data-no-column='{{$k}}'>
            ...
            <form method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                ...
                <div class="box-body">
                    ...
                    <div class='callout callout-success'>
                        ...
                        * If you have big file data, we can't guarantee that uploading will be successful. So, please split those files into some parts of file (at least max 5 MB).<br/>
                        * This tool will generate data automatically so, be careful about your table csv structure.<br/>
                    ...
                    <label for='userfile' class='col-sm-2 control-label'>File to Import: </label>
                    <div class='col-sm-4'>
                    ...
                    <label for='upload_option' class='col-sm-2 control-label'>Upload Option:</label>
                    <div class='col-sm-4'>
                        <select class='form-control' id='upload_option' name='upload_option' required>
                        <option value="">** Please select an Upload Option</option>
                        <option value="1">Upload and Save New Data</option>
                        <option value="2">Upload and Overwrite Data</option>`
                        <option value="3">Delete Existing and Save New Data</option>
                        </select>
                    </div>
