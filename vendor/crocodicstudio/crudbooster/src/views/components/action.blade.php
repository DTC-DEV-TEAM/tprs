@foreach($addaction as $a)
    ...
    if (isset($a['showIf'])) {
        ...
        @eval("if($query) {
          echo \"<a class='btn btn-xs' title='\$title' onclick='\$confirm_box' href='\$url'><i class='\$icon'></i> $label</a>&nbsp;\";
      }");
    } else {
        echo "<a class='btn btn-xs' title='$title' onclick='$confirm_box' href='$url'><i class='$icon'></i> $label</a>&nbsp;";
    }
...
@if($button_action_style == 'button_text')
    ...
    @if(CRUDBooster::isRead() && $button_detail)
        <a class='btn btn-xs btn-detail' title='{{trans("crudbooster.action_detail_data")}}'
    ...
    @if(CRUDBooster::isUpdate() && $button_edit)
        <a class='btn btn-xs btn-edit' title='{{trans("crudbooster.action_edit_data")}}'
    ...
    @if(CRUDBooster::isDelete() && $button_delete)
        ...
        <a class='btn btn-xs btn-delete' title='{{trans("crudbooster.action_delete_data")}}' href='javascript:;'
...
@elseif($button_action_style == 'dropdown')
    ...
    <div class='btn-group btn-group-action'>
        <button type='button' class='btn btn-xs btn-action'>{{trans("crudbooster.action_label")}}</button>
