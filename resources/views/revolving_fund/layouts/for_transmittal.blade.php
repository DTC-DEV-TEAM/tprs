  ...
  <div class='panel-body'>
      ...
      <div class='form-group'>
        <div class="request_content">
                  ...
                  <div class="budget_description" id="budget_justification" style="width: 200px;">
                    <div style="width: 200px;">
                      ...
                      @foreach ($img as $receipts_img)
                        ...
                        @else
                          <img src="{{ asset('revolving_fund/img/'.$receipts_img) }}" alt="No Image Inserted" style="height: 75px; width: 49%; display: inline-block; margin-top: 2px;" id="budget_image" class="modal-trigger" loading="lazy">
                        @endif
                      @endforeach
                      <div class="modal">
          ...
          <div class="receipts_amount_contents">
            <div class="total_amount_content receipts_total_amount">
              <label for="">Date transmitted: <span style="color: red; font-weight: bold;">* </span></label>
