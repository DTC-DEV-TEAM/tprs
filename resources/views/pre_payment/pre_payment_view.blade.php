                ...
                <div class="request_content">
                            ...
                            <div class="budget_block">
                                <div class="budget">
                                    <div class="budget_description">
                                        ...
                                        <input class="input_description" type="text" value="{{ $budget->description }}"
                                    ...
                                    <div class="budget_description">
                                        ...
                                        <input type="number" name="amount[]" min="0" class="budget_amount"
                                            value="{{ $budget->amount }}" id="cash_in_bank_total_value" disabled>
                                    </div>
                                            ...
                                            @foreach ($img as $receipts_img)
                                                ...
                                                @else
                                                    <img src="{{ asset('pre_payment/img/' . $receipts_img) }}"
                                                        ...
                                                        id="budget_image" class="modal-trigger">
                                                @endif
                                            @endforeach
                                            <div class="modal">
                    ...
                    <div class="receipts_amount_contents">
                        <div class="total_amount_content receipts_total_amount">
                            ...
                            <input style="border: none; background-color: #fff;" value="{{ $row->reference_number }}"
                                readonly>
                        </div>
                        @if (CRUDBooster::myPrivilegeName() != 'Requestor')
                            <div class="total_amount_content receipts_total_amount">
                                <label for="">BEACH pre-payment#:</label>
                                <input style="border: none; background-color: #fff;"
                                    value="{{ $row->system_reference_number }}" readonly>
                            </div>
                            <div class="total_amount_content receipts_total_amount">
                                <label for="">AR reference#:</label>
                                <input style="border: none; background-color: #fff;"
                                    value="{{ $row->ar_reference_number }}" readonly>
                            </div>
                        @endif
                    </div>
                    <div class="receipts_amount_contents">
                        ...
                        <div class="total_amount_content receipts_total_amount">
                            ...
                            <input type="number" id="total_amount" value="{{ $row->total_amount }}"
                                name="total_amount" readonly>
                        </div>
                        <div class="total_amount_content receipts_total_amount">
                            <label for="">Unused Amount:</label>
                            <input type="number" id="unused_amount" value="{{ $row->unused_amount }}"
                                name="unused_amount" readonly>
                        </div>
                        <div class="total_amount_content receipts_total_amount">
                            <label for="">Remaining Balance:</label>
                            <input type="number" id="remaining_balance" value="{{ $row->balance_amount }}"
