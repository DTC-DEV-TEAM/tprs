          ...
          <div class="budget">
              ...
              <div class="budget_description" id="step3_budget_justification">
                  ...
                  <div class="upload_img_parent">
                      <input style="" type="file" name="budget_justification[]"
                          accept="image/png, image/gif, image/jpeg" id="upload_img" disabled>
                  </div>
              </div>
  ...
  <div class='panel panel-default'>
      ...
      <form id="close" method="POST" action="{{ CRUDBooster::mainpath('edit-save/' . $row->id) }}"
                  ...
                  <div class="request_content">
                          ...
                          @foreach ($pre_payment_body as $budget)
                              <div class="budget_block">
                                  <div class="budget">
                                      <div class="budget_description">
                                          <label for="">Description</label>
                                          <input class="input_description" type="text"
                                              value="{{ $budget->description }}" name="description[]"
                                              oninput="this.value = this.value.toUpperCase()" required>
                                      </div>
                                      <div class="budget_description">
                                          <label for="">Concept</label>
                                      ...
                                      <div class="budget_description">
                                          ...
                                          <select class="js-example-basic-single location" name="location[]">
                                              ...
                                              @foreach ($locations as $location)
                                                  ...
                                                  @endif
                                                  <option value="{{ $location->id }}">{{ $location->store_name }}
                                                  </option>
                                              @endforeach
                                          </select>
                                      </div>
                                      ...
                                      <div class="budget_description" id="select_account">
                                          ...
                                          <select class="js-example-basic-single account" name="account[]">
                                              <option value="{{ $budget->account_id }}" selected="selected">
                                                  {{ $budget->account_name }}</option>
                                          </select>
                                      </div>
                                      <div class="budget_description">
                                          <label for="">Currency</label>
                                      ...
                                      <div class="budget_description">
                                          <label for="">Total Value</label>
                                          <input type="number" name="amount[]" min="0" class="budget_amount"
                                              id="cash_in_bank_total_value" value="{{ $budget->amount }}">
                                      </div>
                                      <div class="budget_description" id="budget_justification"
                                          ...
                                          <div style="width: 200px;">
                                              ...
                                              @foreach ($img as $receipts_img)
                                                  ...
                                                  @else
                                                      <img src="{{ asset('pre_payment/img/' . $receipts_img) }}"
                                                          alt="No Image Inserted"
                                                          style="height: 75px; width: 49%; display: inline-block; margin-top: 2px;"
                                                          id="budget_image" class="modal-trigger" loading="lazy">
                                                  @endif
                                              @endforeach
                                              <div class="modal">
                                      ...
                                      <div class="budget_description" style="text-align: center;">
                                          <div class="budget_description_btns">
                                              {{-- <button type="button" class="add_row_receipt" style="width: 100px;">Add Row</button>
                        <button type="button" class="delete_row" style="display: none;">Delete</button> --}}
                                              <input type="id" name="returns_id[]" value="{{ $budget->id }}"
                                                  style="display: none;">
                                              <input type="id" name="project_id[]" value="{{ $row->id }}"
                                                  style="display: none;">
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div class="receipts_amount_contents">
                          ...
                          <div class="total_amount_content receipts_total_amount">
                              ...
                              <input class="read_only" type="number" id="total_amount"
                                  value="{{ $row->total_amount }}" name="total_amount" readonly>
                          </div>
                          <div class="total_amount_content receipts_total_amount">
                              <label for="">Unused Amount:</label>
                              <input class="read_only" type="number" id="unused_amount"
                                  value="{{ $row->unused_amount }}" name="unused_amount" readonly>
                          </div>
                          <div class="total_amount_content receipts_total_amount">
                              <label for="">Remaining Balance:</label>
                              <input class="read_only" type="number" id="remaining_balance"
                                  value="{{ $row->balance_amount }}" name="remaining_balance" readonly>
                          </div>
                      </div>
                      ...
                      <div>
                          <span style="font-size: 15px;"><span style="color: red; font-weight: bold;">Notes:
                              </span>"Please turnover all physical / digital receipts, and unused balance to the
