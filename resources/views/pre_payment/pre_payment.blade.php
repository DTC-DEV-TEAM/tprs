...
@section('content')
                    ...
                    <div class="request_content">
                        ...
                        <div style="display: flex; flex-wrap: wrap;">
                            ...
                            <div class="requestor_name" style="margin-right: 30px;">
                                ...
                                <input type="date" id="datePicker" name="need_by_date" style="padding: 0 15px;" required>
                            </div>
                        </div>
                        ...
                        <div class="total_amount_content">
                            ...
                            <input type="number" id="total_amount" name="requested_amount" value="0"
                                min="1" required>
                        </div>
    ...
    <script>
        //calendar that can only select current date and onwards
