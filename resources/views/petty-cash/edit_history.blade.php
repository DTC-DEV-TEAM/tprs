                                                ...
                                                <tr>
                                                    @foreach($Body as $rowresult)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td >
                                                                        <input type="text" class="form-control"  id="si_or_number" name="si_or_number[]"  required value="{{$rowresult->si_or_number}}" >   
                                                            </td>
                                                            ...
                                                            <td >
                                                                        ...
                                                                        <div class="input-group date">
                                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                                            <input type='input' name='si_or_date[]' value="{{$rowresult->si_or_date}}" id="datepicker{{$tableRow}}" onkeydown="return false" required  autocomplete="off"  class='form-control dateset' placeholder="yyyy-mm-dd" />     
                                                                        </div>
