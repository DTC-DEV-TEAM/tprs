                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type='input' name='si_or_date' id="datepicker" onkeydown="return false" required  autocomplete="off"  class='form-control' placeholder="yyyy-mm-dd" value="{{$Header->si_or_date}}" />     
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="address" name="address"  required  value="{{$Header->address}}" >   
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="tin_number" name="tin_number"  required value="{{$Header->tin_number}}" >   
                            </div>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        border-collapse: collapse; box-shadow: rgba(0, 0, 0, 0.15) 2.4px 2.4px 3.2px;">
                                            ...
                                            <tr class="tbl_header_color dynamicRows">
                                                ...
                                                <th width="7%" class="text-center">{{ trans('message.table.invoice_type_id') }}</th>
                                                <th width="6%" class="text-center">{{ trans('message.table.vat_type_id') }}</th>
                                                ...
                                                <th width="9%" class="text-center">{{ trans('message.table.account_id_text') }}</th>
                                                ...
                                                <th width="4%" class="text-center">{{ trans('message.table.line_value_text') }}</th>
                                                    ...
                                                    @foreach($Body as $rowresult)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td >
                                                                        ...
                                                                        <div class="input-group date">
                                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                                            <input type='input' name='si_or_date[]' id="datepicker{{$tableRow}}" onkeydown="return false" required  autocomplete="off"  class='form-control dateset' placeholder="yyyy-mm-dd" />     
                                                                        </div>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr id="tr-table1" class="bottom">
                                                ...
                                                <td colspan="12" align="right"><strong>{{ trans('message.table.total_value_order_text') }}</strong></td>
  ...
  $(document).ready(function() {
    ...
    tableRowtableRow++;
      var newrow = '<tr>' +
       ...
       '<td >' +
            '<input type="hidden"  class="form-control"  name="item_id_add[]"  required  value="'+ tableRowtableRow +'">'+
        ...
        '<td >' +
            '<div class="input-group date">' +
                '<div class="input-group-addon"><i class="fa fa-calendar"></i></div>' +
                    '<input type="input" name="si_or_date_add[]" id="datepicker'+ tableRowtableRow +'" onkeydown="return false" required  autocomplete="off"  class="form-control dateset" placeholder="yyyy-mm-dd" /> ' +    
                '</div>' +
        '</td>' +     

        '<td>' +
        '  <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control itemDesc" data-id="' + tableRowtableRow + '" id="itemDesc' + tableRowtableRow + '"  name="particulars_add[]"  required maxlength="100">' +
        '</td>' +
        ...
        '<td>'+
        '<select class="form-control drop'+ tableRowtableRow + '" name="category_id_add[]" data-id="' + tableRowtableRow + '"  id="category_id" required>' +
        '  <option value="">-Please Select Category-</option>' +
        '        @foreach($Categories as $data)'+
        '        <option value="{{$data->id}}">{{$data->category_name}}</option>'+
        '         @endforeach'+
        ...
        '<td>'+
            ...
            '<input type="hidden"  class="form-control"  name="item_action_add[]" id="item_action' + tableRowtableRow + '"  required  value="ADD">'+

            '<select class="form-control account'+ tableRowtableRow + '" name="account_id_add[]" id="account_id_add" required>' +
        ...
        '<td>' +
        '  <input type="number" class="form-control quantity text-center" data-id="' + tableRowtableRow + '" id="quantity' + tableRowtableRow + '" step="any" name="quantity_add[]" min="0" required maxlength="100">' +
        '</td>' +
        '<td>' +
        '  <input type="number" class="form-control vvalue text-center" data-id="' + tableRowtableRow + '" id="value' + tableRowtableRow + '" name="line_value_add[]" step="0.01" min="0" onchange="setTwoNumberDecimal(this)" required maxlength="100">' +
        '</td>' +
        '<td>' +
        '  <input type="text" class="form-control totalV text-center" id="totalValue' + tableRowtableRow + '" name="total_value_add[]" readonly="readonly" step="0.01" required maxlength="100">' +
        '</td>' +
        '<td>' +


        '<button id="deleteRow" name="removeRow1" class="btn btn-danger removeRow1" data-id="' + tableRowtableRow + '" ><i class="glyphicon glyphicon-trash"></i></button>' +
        '</td>' +
        '</tr>';
      $(newrow).insertBefore($('table tr#tr-table1:last'));

      $( "#datepicker"+tableRowtableRow).datepicker( { maxDate: 0, dateFormat: 'yy-mm-dd' } );
...
for (let i = 1; i < tableRowtableRow + 1; i++) {
    ...
    $( "#datepicker"+i).datepicker( { maxDate: 0, dateFormat: 'yy-mm-dd' } );
