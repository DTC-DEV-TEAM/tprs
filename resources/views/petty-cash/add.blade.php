...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label require">{{ trans('message.form-label.department_id') }} <span
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label require">{{ trans('message.form-label.sub_department_id') }} <span
                                    class="required">*</span></label>
                            <div class="input-group date">
                                <div class="input-group-addon"><i class="fa fa-sticky-note"></i></div>
    ...
    @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label require">{{ trans('message.form-label.requestor_name') }}<span
                                    class="required">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea placeholder="{{ trans('message.table.comments') }} ..." rows="4" class="form-control"
...
@push('bottom')
    <script type="text/javascript">
        //Calendar with no previous dates
