...
@section('content')
    ...
    <div class='panel panel-default'>
        ...
        <form method='post' id="myform" action='{{ CRUDBooster::mainpath('edit-save/' . $Header->requested_id) }}'
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="file" name="close_receipt[]" id="image" class="image"
                                        style="width:200px;" required accept="image/*" multiple>
            ...
            <div class='panel-footer'>
                ...
                <button class="btn btn-primary pull-right" type="submit" id="btnSubmit"> <i
                    ...
                    {{ trans('message.form.close') }}</button>
            </div>
        </form>
