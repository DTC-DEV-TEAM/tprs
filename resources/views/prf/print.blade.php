                    ...
                    <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form method='' id="myform" action="">
                                    <input type="hidden" value="{{$Header->requested_id}}" name="id">  
        ...
        <div class='panel-body'>    
            <div id="printableArea"> 
                <table width="100%">
                    <tr>
                        <td colspan="4">
                            <h4 align="center" ><strong>PAYMENT REQUEST FORM</strong></h4> 
                    ...
                    <tr style="font-size: 13px;" >
                        ...
                        <td width="20%">
                            <br>
                            <label class="control-label col-md-12" style="margin-top: 2px;"><strong>Mode of Payment:<strong></label>
                        </td>
                        <td width="40%">   
                            <br>        
                    ...
                    <tr style="font-size: 13px;">
                        ...
                        <td>
                            <p style="font-size: 7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EXECUTIVE (IF APPLICABLE)</p>
                        </td>
                    </tr>
                    ...
                    <tr style="font-size: 13px;">
                        ...
                        <td width="40%" colspan="4">
                            ...
                            <p> <strong>Note:</strong>&nbsp;&nbsp;Accounting Department process payables is 3 working days upon received of original Payment Request Form. Please attached
                                approved quotation or any proof that can support your request. This form will be used for NON P.O item such as contract & permits,
    ...
    <script type="text/javascript">
        ...
        //var strconfirm = confirm("Are you sure you want to approve this pull-out request?");
            var data = $('#myform').serialize();
                $.ajax({
                        type: 'GET',
                        url: '{{ url('admin/pending_payment_request/PRFUpdateStatus') }}',
                        data: data,
