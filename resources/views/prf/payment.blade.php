            ...
            <div class='panel-body'>
                ...
                <div class="container-fluid mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label require">*{{ trans('message.form-label.check_number') }}</label>
                                <div style="width: 100%" class="input-group">
                                    <input type="text" name="check_number" id="check_number" required autocomplete="off"
                ...
                <div class='panel-footer'>
                    <a href="{{ CRUDBooster::mainpath() }}"
                        class="btn btn-default">{{ trans('message.form.cancel') }}</a>

                    <button class="btn btn-primary pull-right" type="submit" id="btnSubmit"> <i
                            class="fa fa-check"></i>
                        {{ trans('message.form.confirm_payment') }}</button>
                </div>
        </form>
    </div>
@endsection
