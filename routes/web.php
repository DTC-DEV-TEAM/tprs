...
Route::group(['middleware' => ['web']], function () {
    ...
    //PRFConfirmation
    Route::get('/admin/pending_payment_request/getRequestConfirmation/{id}', 'AdminPendingPaymentRequestController@getRequestConfirmation')->name('confirmation-prf-request');
