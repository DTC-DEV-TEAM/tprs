<?php namespace App\Http\Controllers;
	...
	class AdminPaymentStatusController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "payment_status_name";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Payment Status Name","name"=>"payment_status_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Status Name','name'=>'payment_status_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Payment Status Name","name"=>"payment_status_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
			...
			$(document).ready(function() {
				$('#payment_status_name').keyup(function() {
