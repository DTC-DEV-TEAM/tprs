<?php namespace App\Http\Controllers;
	...
	class AdminCurrencyController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "currency_name";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Currency Name","name"=>"currency_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Currency Name','name'=>'currency_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Currency Name","name"=>"currency_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
