<?php namespace App\Http\Controllers;
	...
	class AdminAccountController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Category","name"=>"category_id","join"=>"category,category_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-5','datatable'=>'category,category_name'];

			$this->form[] = ['label'=>'Account Name','name'=>'account_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
