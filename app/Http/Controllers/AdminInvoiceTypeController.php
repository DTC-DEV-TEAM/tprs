<?php namespace App\Http\Controllers;
	...
	class AdminInvoiceTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "invoice_type_name";
			$this->limit = "20";
			...
			$this->table = "invoice_type";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Invoice Type Name","name"=>"invoice_type_name"];
			...
			$this->form[] = ['label'=>'Invoice Type Name','name'=>'invoice_type_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Invoice Type Name","name"=>"invoice_type_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
			...
			$this->script_js = "
					$(document).ready(function() {
						$('#invoice_type_name').keyup(function() {
