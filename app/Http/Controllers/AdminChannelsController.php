<?php namespace App\Http\Controllers;
	...
	class AdminChannelsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Customer COA Name","name"=>"customer_name"];
			...
			$this->form[] = ['label'=>'Customer COA Name','name'=>'customer_name','type'=>'text','validation'=>'required|min:1|max:25','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'COA ID','name'=>'coa_id','type'=>'text','validation'=>'required|min:1|max:25','width'=>'col-sm-5'];
	        ...
	        */
			...
			$this->script_js = "
				$(document).ready(function() {
					$('#channel_code, #channel_name').keyup(function() {
